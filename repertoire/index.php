...
if(isset($_POST['btnConnecter'])){
    ...
    if($util != null){
        ...
        header("location:/repertoire/index.php?erreur");
    }
}
...
<br>
            ...
            <div class="form">
                ...
                <br>
                <input style="text-transform: uppercase; color: red" type="password" name="password"  required id="materialLoginFormPassword" class="form-control">
