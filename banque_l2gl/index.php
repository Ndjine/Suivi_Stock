...
if(isset($_POST['btnConnecter'])){
    ...
    if($employe != null){
        ...
        header("location:/banque_l2gl/accueil.php");
    } else{
        header("location:/banque_l2gl/index.php?erreur");
    }
}
...
<div class="container mt-4">
    <div class="col-md-8 offset-4">
        <span class="text-uppercase h1 green lighten-2 blue-text col-md-4 ">BANQUE L2 GL</span>
    </div>
</div>
